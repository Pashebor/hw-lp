                    ...
                    <div className="training-consultation">
                            ...
                            <div className="consultation__information-block">
                                ...
                                <div className="consultation__text">
                                    ...
                                    <div className="container__text-description">
                                        Стаж практических занятий астрологией более 6 лет. За это время построила и разобрала более 230 гороскопов, провела 312 консультаций, онлайн и очно.
                                        Имеет десятки отзывов от многочисленных благодарных клиентов, жизнь многих из них после консультации резко поменялась в благоприятном направлении.
                                    </div>
                                    </ScrollableAnchor>
                                    <ul>
                                        <li>Составление индивидуального гороскопа</li>
                                        <li>Прогнозирование</li>
                                        <li>Анализ любовных факторов гороскопа (совместимость)</li>
                                        <li>Выбор подходящей даты важных событий (госпитализация, свадьба, поездки и т. п.)</li>
                                        <li>Гороскоп бизнеса</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div className="consultation__item">
                            ...
                            <div className="consultation__information-block">
                                ...
                                <div className="consultation__text">
                                    <div className="container__text-description">
                                        В астрологии более 5 лет. На протяжении 3 лет помогает людям разобраться, с кем можно связать свою судьбу,
                                        на какой знак зодиака обратить внимание, когда мы строим свою карьеру,
                                        а представитель какого знака зодиака станет для них лучшим другом до конца жизни.
                                    </div>
                                    <ul>
                                        <li>
                                            Прогнозирование
                        ...
                        <div className="consultation__item">
                            <div className="consultation__name">
                                <span className="pink-name">Вилена Ярославцева</span> - Консультант астролог
                            </div>
                            <div className="consultation__information-block">
                                <div className="consultation__photo">
                                    <img src="images/cons5.jpg" alt="Вилена Ярославцева" title="Вилена Ярославцева"/>
                                </div>
                                <div className="consultation__text">
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            Подробный гороскоп на 1 год
                                        </li>
                                        <li>
                                            Хорарная астрология - быстрый ответ на быстрый вопрос
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="consultation__item">
                            ...
                            <div className="consultation__information-block">
                                ...
                                <div className="consultation__text">
                                    <div className="container__text-description">
                                        Занимается астрологией с 2011 года. Главной ценностью является человек: его чувства, мечты и цели.
                        ...
                        <div className="consultation__item">
                            ...
                            <div className="consultation__information-block">
                                ...
                                <div className="consultation__text">
                                    <div className="container__text-description">
                                        Стаж практических занятий астрологией более 5 лет. Является профессиональным астрологом.
                                        В своей работе придерживается принципов научной астрологии и концепции «Формул Событий» (события определяются по специальным формулам).
                                    </div>
                                    <ul>
                                        <li>
                                            Составление и расшифровка натальной карты
